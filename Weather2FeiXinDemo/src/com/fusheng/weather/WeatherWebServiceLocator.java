...
package com.fusheng.weather;

public class WeatherWebServiceLocator extends org.apache.axis.client.Service implements com.fusheng.weather.WeatherWebService {
 ...
 */
    ...
    public com.fusheng.weather.WeatherWebServiceSoap_PortType getWeatherWebServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public com.fusheng.weather.WeatherWebServiceSoap_PortType getWeatherWebServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.fusheng.weather.WeatherWebServiceSoap_BindingStub _stub = new com.fusheng.weather.WeatherWebServiceSoap_BindingStub(portAddress, this);
    ...
    public com.fusheng.weather.WeatherWebServiceSoap_PortType getWeatherWebServiceSoap12() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public com.fusheng.weather.WeatherWebServiceSoap_PortType getWeatherWebServiceSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.fusheng.weather.WeatherWebServiceSoap12Stub _stub = new com.fusheng.weather.WeatherWebServiceSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.fusheng.weather.WeatherWebServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.fusheng.weather.WeatherWebServiceSoap_BindingStub _stub = new com.fusheng.weather.WeatherWebServiceSoap_BindingStub(new java.net.URL(WeatherWebServiceSoap_address), this);
                _stub.setPortName(getWeatherWebServiceSoapWSDDServiceName());
                return _stub;
            }
            if (com.fusheng.weather.WeatherWebServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.fusheng.weather.WeatherWebServiceSoap12Stub _stub = new com.fusheng.weather.WeatherWebServiceSoap12Stub(new java.net.URL(WeatherWebServiceSoap12_address), this);
                _stub.setPortName(getWeatherWebServiceSoap12WSDDServiceName());
                return _stub;
            }
        }
